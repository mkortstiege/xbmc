...
namespace GUIINFO
{
std::string CFileItemInfoProvider::GetLabel(const CFileItemPtr& item, int info)
{
  switch (info)
  {
  case LISTITEM_LABEL:
...
std::string CFileItemInfoProvider::GetDirector(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetAlbum(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag())
...
std::string CFileItemInfoProvider::GetYear(const CFileItemPtr& item)
{
  std::string year;
...
std::string CFileItemInfoProvider::GetPremiered(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag())
  {
    CDateTime dateTime;
...
std::string CFileItemInfoProvider::GetGenre(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetDate(const CFileItemPtr& item)
{
  if (item->HasEPGInfoTag())
...
std::string CFileItemInfoProvider::GetRating(const CFileItemPtr& item)
{
  std::string rating;
...
std::string CFileItemInfoProvider::GetRatingAndVotes(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag() && item->GetVideoInfoTag()->m_fRating > 0.f) // movie rating
  {
...
std::string CFileItemInfoProvider::GetDuration(const CFileItemPtr& item)
{
  std::string duration;
...
std::string CFileItemInfoProvider::GetPlot(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetPlotOutline(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetEpisode(const CFileItemPtr& item)
{
  int iSeason = -1;
  int iEpisode = -1;
...
std::string CFileItemInfoProvider::GetSeason(const CFileItemPtr& item)
{
  int iSeason = -1;
  if (item->HasPVRChannelInfoTag())
  {
...
std::string CFileItemInfoProvider::GetIcon(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetFoldernameOrPath(const CFileItemPtr& item, int info)
{
  std::string path;
...
std::string CFileItemInfoProvider::GetFilenameAndPath(const CFileItemPtr& item)
{
  std::string path;
  if (item->IsMusicDb() && item->HasMusicInfoTag())
...
std::string CFileItemInfoProvider::GetTop250(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag())
  {
...
std::string CFileItemInfoProvider::GetSortLetter(const CFileItemPtr& item)
{
  std::string letter;
...
std::string CFileItemInfoProvider::GetAudioChannels(const CFileItemPtr& item)
{
  std::string strResult;
...
std::string CFileItemInfoProvider::GetStartTime(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetEndTime(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetStartDate(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetEndDate(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetChannelNumber(const CFileItemPtr& item)
{
  std::string number;
...
std::string CFileItemInfoProvider::GetSubChannelNumber(const CFileItemPtr& item)
{
  std::string number;
...
std::string CFileItemInfoProvider::GetChannelNumberLabel(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetChannelName(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
...
std::string CFileItemInfoProvider::GetNextStartTime(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
...
std::string CFileItemInfoProvider::GetNextEndTime(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextStartDate(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextEndDate(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextPlot(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextPlotOutline(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetEpisodeName(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetNextDuration(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextGenre(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetNextTitle(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNext());
...
std::string CFileItemInfoProvider::GetParentalRating(const CFileItemPtr& item)
{
  std::string rating;
...
std::string CFileItemInfoProvider::GetDBID(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag())
...
std::string CFileItemInfoProvider::GetStereoscopicMode(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetImdbNumber(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetFilenameOrExtentsion(const CFileItemPtr& item, int info)
{
  std::string strFile;
...
std::string CFileItemInfoProvider::GetTitle(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto epgTag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetEpgEventTitle(const CFileItemPtr& item)
{
  if (item->HasEPGInfoTag())
    return item->GetEPGInfoTag()->Title();
...
std::string CFileItemInfoProvider::GetOriginalTitle(const CFileItemPtr& item)
{
  if (item->HasPVRChannelInfoTag())
  {
    auto tag(item->GetPVRChannelInfoTag()->GetEPGNow());
...
std::string CFileItemInfoProvider::GetPlayCount(const CFileItemPtr& item)
{
...
std::string CFileItemInfoProvider::GetLastPlayed(const CFileItemPtr& item)
{
  CDateTime dateTime;
...
std::string CFileItemInfoProvider::GetTrackNumber(const CFileItemPtr& item)
{
  std::string track;
...
std::string CFileItemInfoProvider::GetDiscNumber(const CFileItemPtr& item)
{
  std::string disc;
...
std::string CFileItemInfoProvider::GetArtist(const CFileItemPtr& item)
{
  if (item->HasVideoInfoTag())
